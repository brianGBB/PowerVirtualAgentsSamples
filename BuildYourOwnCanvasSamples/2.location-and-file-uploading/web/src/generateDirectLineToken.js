...
module.exports = async function generateDirectLineToken(botId, botTenantId) {
  ...
  const response = await fetch('https://7436d0405e8c4f2fbb6f672d449892.ea.environment.api.powerplatform.com/powervirtualagents/botsbyschema/cr196_directLine/directline/token?api-version=2022-03-01-preview&botId=directlinetoken?botId=' + botId + '&tenantId=' + botTenantId, {method: "GET"});
